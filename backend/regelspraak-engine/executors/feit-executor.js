...
class FeitExecutor {
    expressionEvaluator;
    constructor() {
        this.expressionEvaluator = new expression_evaluator_1.ExpressionEvaluator();
    }
    /**
     ...
     */
    executeFeitCreatie(feit, context) {
        try {
     ...
     */
    navigateFeitCreatieSubject(subject, role, context) {
     ...
     */
    resolveSubject(subject, context) {
        if (subject.type === 'AttributeReference') {
            const ref = subject;
     ...
     */
    findMatchingFeittype(roleName, context) {
     ...
     */
    matchesDescription(obj, description) {
        if (obj.type !== 'object')
            return false;
...
exports.FeitExecutor = FeitExecutor;
//# sourceMappingURL=feit-executor.js.map