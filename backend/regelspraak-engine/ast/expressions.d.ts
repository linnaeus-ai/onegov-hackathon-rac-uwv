...
export interface BinaryExpression extends Expression {
    ...
    operator: '+' | '-' | '*' | '/' | '==' | '!=' | '>' | '<' | '>=' | '<=' | '&&' | '||' | 'is een dagsoort' | 'zijn een dagsoort' | 'is geen dagsoort' | 'zijn geen dagsoort' | 'is numeriek met exact' | 'is niet numeriek met exact' | 'zijn numeriek met exact' | 'zijn niet numeriek met exact';
    left: Expression;
    right: Expression;
}
...
export interface UnaryExpression extends Expression {
    ...
    operator: '-' | '!' | 'niet' | 'voldoet aan de elfproef' | 'voldoen aan de elfproef' | 'voldoet niet aan de elfproef' | 'voldoen niet aan de elfproef' | 'moeten uniek zijn';
    operand: Expression;
}
